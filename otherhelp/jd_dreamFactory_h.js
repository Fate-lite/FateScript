...
[task_local]
#京喜工厂
18 0 * * * jd_dreamFactory_h.js, tag=京喜工厂, img-url=https://github.com/58xinian/icon/raw/master/jdgc.png, enabled=true

================Loon==============
[Script]
cron "18 0 * * *" script-path=jd_dreamFactory_h.js,tag=京喜工厂

===============Surge=================
京喜工厂 = type=cron,cronexp="18 0 * * *",wake-system=1,timeout=3600,script-path=jd_dreamFactory_h.js

============小火箭=========
京喜工厂 = type=cron,script-path=jd_dreamFactory_h.js, cronexpr="18 0 * * *", timeout=3600, enable=true
