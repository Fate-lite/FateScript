...
# 获取互助码并格式化
55 23 * * * https://raw.sevencdn.com/fatelpc/JDScript/main/format_share_jd_code.js, tag=获取互助码并格式化, img-url=https://raw.githubusercontent.com/yogayyy/task/master/huzhucode.png, enabled=true

 */
const $ = new Env("获取互助码并格式化");
const notifyMsg = `
更新互助码获取途径逻辑\n
更新 自定义是否需要开启通知\n
更新 财富到互助码\n
...
if (!$.isNode()) {
    ...
    fs.readFile(file, "utf-8", function (err, data) {
        if (err) {
            ...
            $.shareCodeObj.BookShop = exportShareCodes(arr, "京东书店：");
