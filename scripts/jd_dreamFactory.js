...
let tuanActiveId = `Gskrh9hZJN5MJBkCIrN2eQ==`;
...
async function joinLeaderTuan() {
  $.tuanIdS = null;
  if (!$.tuanIdS) await updateTuanIdsCDN('https://raw.sevencdn.com/fatelpc/JDScript/main/shareCodes/jd_updateFactoryTuanId.json');
...
function requireConfig() {
  return new Promise(async resolve => {
    await updateTuanIdsCDN('https://raw.sevencdn.com/fatelpc/JDScript/main/shareCodes/jd_updateFactoryTuanId.json');
