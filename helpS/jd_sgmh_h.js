...
================Loon==============
[Script]
cron "16 1 * * *" script-path=jd_sgmh_h.js, tag=闪购盲盒

===============Surge=================
闪购盲盒 = type=cron,cronexp="16 1 * * *",wake-system=1,timeout=3600,script-path=jd_sgmh_h.js

============小火箭=========
闪购盲盒 = type=cron,script-path=jd_sgmh_h.js, cronexpr="16 1 * * *", timeout=3600, enable=true
