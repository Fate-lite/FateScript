...
// $.currentToken = {
//     "farm_jstoken": "e0d30fe4de03e0ca4920f89154e2abdd",
//     "phoneid": "d2b7cf60afce53c7",
//     "timestamp": "1621237999420",
//     "pin": "24976137-306905"
// }

$.currentToken = {
    "farm_jstoken": "4d87c1d27afe85363e25b30f08287ac1",
    "phoneid": "b912d9835412e94a",
    "timestamp": "1623891453097",
    "pin": "24976137-306905"
}

// $.currentToken = {
//     "farm_jstoken": "b79d21977faac00216a35e208de7790f",
//     "timestamp": "1623860492867",
//     "phoneid": "c4f73e23c80b5751",
//     "pin": "24976137-306905"
// }
    ...
    return new Promise(async (resolve) => {
        $.get(
            taskUrl(
                ...
                `_cfd_t,bizCode,ddwMinPaperMoney,ddwMoney,dwEnv,dwIsCreateToken,ptag,source,strPgUUNum,strPgtimestamp,strPhoneID,strZone`),
            async (err, resp, data) => {
                try {
                    $.log(data);
...
function taskUrl(function_path, body, stk) {
    let url = `${JD_API_HOST}jxcfd/${function_path}?strZone=jxcfd&bizCode=jxcfd&source=jxcfd&dwEnv=7&_cfd_t=${Date.now()}&ptag&${body}&_ste=1&_=${Date.now()}&sceneval=2&g_login_type=1&g_ty=ls`;
    if (stk) {
        url += `&_stk=${stk}`;
    }
