...
===========Surge=================
[Script]
宠汪汪邀请助力与赛跑助力 = type=cron,cronexp="30 10-18/1 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/Aaron-lv/sync/jd_scripts/jd_joy_run.js
...
[task_local]
# 宠汪汪邀请助力与赛跑助力
30 10-18/1 * * * https://raw.githubusercontent.com/Aaron-lv/sync/jd_scripts/jd_joy_run.js, tag=宠汪汪邀请助力与赛跑助力, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jdcww.png, enabled=true
[rewrite_local]
# 宠汪汪助力更新Token
...
=====================Loon=====================
[Script]
cron "30 10-18/1 * * *" script-path=https://raw.githubusercontent.com/Aaron-lv/sync/jd_scripts/jd_joy_run.js, tag=宠汪汪邀请助力与赛跑助力
...
async function main() {
    ...
    console.log(`当前token：${$.LKYLToken ? $.LKYLToken : '暂无token'}\n`)
    if (!$.LKYLToken) {
