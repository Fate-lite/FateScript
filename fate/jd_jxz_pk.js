/*
京享值PK
cron 15 0,6,13,19,21 * * * jd_jxz_pk.js
更新时间：2021-6-4
活动入口：京东APP-我的-京享值
...
[task_local]
#京喜财富岛
15 0,6,13,19,21 * * * https://raw.githubusercontent.com/hyzaw/scripts/main/jd_jxz_pk.js, tag=京喜财富岛

================Loon==============
[Script]
cron "15 0,6,13,19,21 * * *" script-path=https://raw.githubusercontent.com/hyzaw/scripts/main/jd_jxz_pk.js,tag=京喜财富岛

===============Surge=================
京喜财富岛 = type=cron,cronexp="15 0,6,13,19,21 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/hyzaw/scripts/main/jd_jxz_pk.js

============小火箭=========
京喜财富岛 = type=cron,script-path=https://raw.githubusercontent.com/hyzaw/scripts/main/jd_jxz_pk.js, cronexpr="15 0,6,13,19,21 * * *", timeout=3600, enable=true
 */
const $ = new Env('京享值PK');
$.toObj = (t, e = null) => {
	try {
