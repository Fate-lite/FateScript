...
[task_local]
#惊喜牧场
20 * * * * https://gitee.com//jx_mcCollectCow.js, tag=惊喜牧场, img-url=https://github.com/58xinian/icon/raw/master/jdgc.png, enabled=true

================Loon==============
[Script]
cron "20 * * * *" script-path=https://gitee.com/jx_mcCollectCow.js,tag=惊喜牧场

===============Surge=================
惊喜牧场 = type=cron,cronexp="20 * * * *",wake-system=1,timeout=3600,script-path=https://gitee.com/jx_mcCollectCow.js

============小火箭=========
惊喜牧场 = type=cron,script-path=https://gitee.com//jx_mcCollectCow.js, cronexpr="20 * * * *", timeout=3600, enable=true
 */
// prettier-ignore
    ...
    switch (type) {
        ...
        case 'mowing':
            ...
            if (data.ret === 0) {
                ...
                console.log(`除草获得金币：${$.mowingInfo.addcoins} \n`)
            }
            break;
        case 'jump':
            data = JSON.parse(data.match(new RegExp(/jsonpCBK.?\((.*);*/))[1]);
