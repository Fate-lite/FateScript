 ...
 * [Script]
 *
 * cron 15 1-23/4 * * * jd_xxl_dd.js
 * cron "15 1-23/4 * * *" jd_xxl_dd.js,tag=个护爱消除
 *
 */
...
$.maxLevel = process.env.xxlDDMaxLevel ?? 640;
            ...
            if (err) {
              ...
              if (safeGet(data)) {
                ...
                if (data.code === 0) {
                  ...
                  if (data.dayInfo.dayPlayNums < 10 && data.dayInfo.score < $.maxScore ) {
          ...
          try {
            if (err) {
              ...
              if (safeGet(data)) {
                ...
                // console.log(data)
                if (data.code === 0) {
                  console.log(`每日挑战开启成功，本日挑战次数${data.dayInfo.dayPlayNums}/10`)
