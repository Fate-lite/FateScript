...
[task_local]
#口袋书店
1 8,12,18 * * *  scripts/wen/jd/jd_book_help.js, tag=口袋书店, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true

================Loon==============
[Script]
cron "1 8,12,18 * * *" script-path= scripts/wen/jd/jd_book_help.js,tag=口袋书店

===============Surge=================
口袋书店 = type=cron,cronexp="1 8,12,18 * * *",wake-system=1,timeout=3600,script-path= scripts/wen/jd/jd_book_help.js

============小火箭=========
口袋书店 = type=cron,script-path= scripts/wen/jd/jd_book_help.js, cronexpr="1 8,12,18* * *", timeout=3600, enable=true
 */
const $ = new Env('口袋书店互助');
...
let inviteCodes = [
    '21cf43f0bd0449549d9811956b55c7df'
]
