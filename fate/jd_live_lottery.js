/**
 * 直播抽奖
 * cron 0 * * * * jd_my_query.js
 * @type {{toObj(*=, *=): (any|undefined), done(*=): void, lodash_set(*=, *=, *): *, getdata(*): *, isLoon(): boolean, lodash_get(*, *, *): (*), setjson(*=, *=): (boolean|undefined), wait(*=): Promise<unknown>, isNode(): *, loaddata(): ({}|undefined), writedata(): void, msg(*=, *=, *=, *=): void, initGotEnv(*=): void, isSurge(): *, getjson(*=, *): *, isQuanX(): boolean, runScript(*=, *=): Promise<unknown>, getval(*=): *, logErr(*=, *): void, setval(*=, *=): *, setdata(*=, *): *, getScript(*=): Promise<unknown>, toStr(*=, *=): (string|undefined), get(*=, *=): void, post(*=, *=): void, time(*=): *, log(...[*]): void}}
 */
