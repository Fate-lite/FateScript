/*
京享值PK
cron 15 0,6,13,19,21 * * * jd_jxzddo_pk.js
更新时间：2021-6-8
...
[task_local]
#京享值PK
15 0,6,13,19,21 * * * https://raw.githubusercontent.com/jd_jxzddo_pk.js, tag=京享值PK
================Loon==============
[Script]
cron "15 0,6,13,19,21 * * *" script-path=https://raw.githubusercontent.com/jd_jxzddo_pk.js,tag=京享值PK
===============Surge=================
京享值PK = type=cron,cronexp="15 0,6,13,19,21 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/jd_jxzddo_pk.js
============小火箭=========
京享值PK = type=cron,script-path=https://raw.githubusercontent.com/jd_jxzddo_pk.js, cronexpr="15 0,6,13,19,21 * * *", timeout=3600, enable=true
*/
const $ = new Env('京享值ddoPK');
$.toObj = (t, e = null) => {
	try {
		return JSON.parse(t)
	} catch {
