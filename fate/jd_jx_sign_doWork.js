/*
京喜签到
cron 20 1,8 * * * jd_jx_sign_doWork.js
更新时间：2021-7-31
活动入口：京喜APP-我的-京喜签到
...
[task_local]
#京喜签到
20 1,8 * * * https://raw.githubusercontent.com/Aaron-lv/sync/jd_scripts/jd_jx_sign_doWork.js, tag=京喜签到, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jxcfd.png, enabled=true

================Loon==============
[Script]
cron "20 1,8 * * *" script-path=https://raw.githubusercontent.com/Aaron-lv/sync/jd_scripts/jd_jx_sign_doWork.js,tag=京喜签到

===============Surge=================
京喜签到 = type=cron,cronexp="20 1,8 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/Aaron-lv/sync/jd_scripts/jd_jx_sign_doWork.js

============小火箭=========
京喜签到 = type=cron,script-path=https://raw.githubusercontent.com/Aaron-lv/sync/jd_scripts/jd_jx_sign_doWork.js, cronexpr="20 1,8 * * *", timeout=3600, enable=true
 */
...
!(async () => {
    ...
    for (let i = 0; i < $.cookiesArr && i < 25; i++) {
        if (cookiesArr[i]) {
            cookie = cookiesArr[i];
