    ...
    for (let i = 0; i < 1; i++) {
        if (envs[i].status == 0) {
            if (envs[i].value) {
                ...
                await all(envs[i].value, 'reqData={"videoId":"311372930347370496","channelSource":"JRAPP6.0","encryptData":"{\'data\':\'KHTzRx1x+Yc5ziKFxs54CeoYHT9ZFrHBgyHXSJQfdVBOwYAU48ElYIk2bTClB9qFFHHtQarwpLz9Sb4eYHSmoabgRWSOMH/yZdXjJ8JbUy4nFfbEPIWDxHAz2wlLM/Pq7dco1vSEGDS84pZU2NKtaw==\',\'key\':\'\',\'version\':\'2\',\'shakey\':\'4hqrnwGzxzQiAP18jLaMvIBOdi3LB4Aim3BwSrBrpNI=\'}","riskDeviceParam":"{\\"eid\\":\\"URIXYBI2K7DTVKHDPXGCUPGYSZUF7QWHUE5YZQXPPWCBBLDZ3FMIG7JIAAE7OPZPBQKU6WJUBSJRTOQTS3MNKVF6X4\\",\\"fp\\":\\"2470451d941af6609a0fb1fc71da1544\\",\\"sdkToken\\":\\"jdd01F4R5O3ELTI553F3KH5BXNYW6DPIWDHL63SQY66U72X7APC4IXRV3GNNUD25PCRDCMKPIMGANG6DDBQU37TOYJUFQEIA4QFQUJI44EVI01234567\\",\\"token\\":\\"PIYMIKZZTQNIR2IL4JUECWM3LPTB4LYYMSJYBGKPKZ43XOL7ABTEK3G2DCX7GLVQIC7PV7LQMSGR4\\",\\"jstub\\":\\"D3T55B6VY6LU2X4NXLN7MSOB6QJN6A24BUC3BSNHX5VRRWYFRHDFRZ6MMVXGOX72A6LCURMKUT7BY35B2MMMWO3OU4CLFEOXD4DQZVY\\"}","channel":"sy","channelLv":"sy"}');
            }
        }
    }
})().catch(e => {
