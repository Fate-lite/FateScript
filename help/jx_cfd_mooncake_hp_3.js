...
[task_local]
#京喜财富岛合成月饼助力
10 6,13,23 * * * https://raw.githubusercontent.com/Aaron-lv/sync/jd_scripts/jx_cfd_mooncake_hp.js, tag=京喜财富岛合成月饼助力, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jxcfd.png, enabled=true

================Loon==============
[Script]
cron "10 6,13,23 * * *" script-path=https://raw.githubusercontent.com/Aaron-lv/sync/jd_scripts/jx_cfd_mooncake_hp.js,tag=京喜财富岛合成月饼助力

===============Surge=================
京喜财富岛合成月饼助力 = type=cron,cronexp="10 6,13,23 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/Aaron-lv/sync/jd_scripts/jx_cfd_mooncake_hp.js

============小火箭=========
京喜财富岛合成月饼助力 = type=cron,script-path=https://raw.githubusercontent.com/Aaron-lv/sync/jd_scripts/jx_cfd_mooncake_hp.js, cronexpr="10 6,13,23 * * *", timeout=3600, enable=true
 */
    ...
    try {
        ...
        if ($.index > $.runHelpUser){
            ...
            for (let j = 0; j < $.helpShareCode.length && $.canHelp; j++) {
                console.log(`账号${$.UserName} 去助力 ${$.helpShareCode[j]}\n`)
                $.delcode = false
